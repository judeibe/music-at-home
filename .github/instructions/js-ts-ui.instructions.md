...
- For relevant work, **explicitly use the project skills in `@.agents/skills`**: `context7-mcp`, `shadcn`, and `frontend-design`.
- Prefer these local skills as the first mechanism for library context and UI implementation patterns.
